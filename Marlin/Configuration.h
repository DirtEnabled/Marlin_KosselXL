...
#define CUSTOM_MACHINE_NAME "Doug Kossel XL"
...
#define HOTEND_OFFSET_X { 00.00, -24.50 } // (mm) relative X-offset for each nozzle
...
#define DELTA
  ...
  #define DELTA_MAX_RADIUS       150.00    // (mm)

  // Center-to-center distance of the holes in the diagonal push rods.
  #define DELTA_DIAGONAL_ROD 377.00      // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 468.62             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { -1.300, 0.000, -1.040 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 186.96              // (mm) Get this value from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { -0.100, 0.070, 0.030 } // Get these values from G33 auto calibrate
 ...
 */
#define Z_MIN_PROBE_PIN PA2 // DOUG SET PIN //Pin 32 is the RAMPS default
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -12.25, -15.0, 0 }
...
#define Z_PROBE_LOW_POINT          -10 // DOUG Changed - Farthest distance below the trigger-point to go before stopping
 ...
 */
#define PROBING_HEATERS_OFF       // DOUG TURNED ON FOR DEBUG //Turn heaters off when probing
...
//#define PREHEAT_BEFORE_PROBING  //Doug - Trun back on once leveling is working
...
#define MIN_SOFTWARE_ENDSTOPS
  ...
  //#define MIN_SOFTWARE_ENDSTOP_I  //Doug removed these
...
#define MAX_SOFTWARE_ENDSTOPS
  ...
  //#define MAX_SOFTWARE_ENDSTOP_I  //Doug - removed these
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FIL_RUNOUT_PIN   PE15 //Doug added pinout // SKR Pro v1.1 Stock Sensor E0 X_MAX_PIN
  //#define FIL_RUNOUT1_PULLDOWN

  #define FIL_RUNOUT2_STATE HIGH
  #define FIL_RUNOUT2_PULLUP
  #define FIL_RUNOUT2_PIN    PE10 //Doug added pinout
 ...
 */
//#define PREHEAT_BEFORE_LEVELING  //DOUG TURN ON AFTER DEBUG
...
//#define PASSWORD_FEATURE
  ...
  #define PASSWORD_CHANGE_GCODE UBL            // Change the password with M512 P<old> S<new>.
